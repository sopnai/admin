...
import { getSingleClientAction, addClientAction } from "store/actions";
...
const ClientAdd = () => {
    ...
    document.title = "Add Client | Flawless Admin Panel";
    ...
    const handleSubmit = async () => {
        ...
        clientAdd.append('firstName', formData?.firstName);
        clientAdd.append('lastName', formData?.lastName);
        clientAdd.append('email', formData?.email);
        clientAdd.append('phone', formData?.phone);
        clientAdd.append('countryCode', formData?.countryCode || '');
        clientAdd.append('address', formData?.address || '');

        if (profileImage) {
            clientAdd.append('profileImage', profileImage);
        }

        clientAdd.append('addresses', JSON.stringify(addressData));

        try {
            await addClientAction(clientAdd).then((res) => {
            ...
            <div className="page-content">
                <div className="container-fluid">
                    ...
                    <Breadcrumb
                        ...
                        btnTitle={
                            <>
                                <i className="fas fa-plus me-1"></i> Add Client Details
                            </>
                        }
                    />
                                ...
                                <CardBody className="m-2">
                                    ...
                                    <Row>
                                        ...
                                        <Col lg={"4"} className="form-group">
                                            ...
                                            <Input value={formData?.firstName} type="text" name="firstName" className="form-control" placeholder="Enter First Name" onChange={handleInputChange} />
                                        </Col>

                                        <Col lg={"4"} className="form-group">
                                            <Label className="req-lab">Last Name</Label>
                                            <Input value={formData?.lastName} type="text" name="lastName" className="form-control" placeholder="Enter Last Name" onChange={handleInputChange} />
                                        </Col>
                                        <Col lg={"4"} className="form-group">
                                            <Label className="req-lab">Email</Label>
                                            <Input value={formData?.email} type="text" name="email" className="form-control" placeholder="Enter Email Id" onChange={handleInputChange} />
                                        </Col>

                                        <Col lg={"4"} className="form-group">
                                            <Label className="req-lab">Country Code</Label>
                                            <Input value={formData?.countryCode} type="number" name="countryCode" className="form-control" placeholder="Enter Code" onChange={handleInputChange} />
                                        </Col>

                                        <Col lg={"4"} className="form-group">
                                            <Label className="req-lab">Mobile</Label>
                                            <Input value={formData?.phone} type="number" name="phone" className="form-control" placeholder="Enter Mobile Number" onChange={handleInputChange} />
                                        </Col>

                                        <Col lg={"4"} className="form-group">
                                            <Label className="">Profile Image</Label>
                                            <Input type="file" accept="image/*" name="profileImage" className="form-control" onChange={handleImageChange}
                                            />
                                            {
                                        ...
                                        <Col lg={"12"} className="form-group">
                                            <Label>Address</Label>
                                            <textarea value={formData?.address} type="text" name="address" className="form-control" placeholder="Enter Address" onChange={handleInputChange} />
                                        </Col>
