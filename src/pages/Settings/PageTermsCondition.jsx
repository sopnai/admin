...
const PageTermsCondition = () => {

    document.title = "Terms and Condition Page | Flawless Admin Panel";
    ...
    const fetchPageData = async () => {
        ...
        if (pagelist?.data[1]?.page_description) {
            const blocksFromHTML = convertFromHTML(pagelist?.data[1]?.page_description);
        ...
        <React.Fragment>
            <div className="page-content">
                <div className="container-fluid">
                    ...
                    <Breadcrumb maintitle="Dashboard" title="Pages" titleLink="/#" breadcrumbItem="Terms and Conditions"
